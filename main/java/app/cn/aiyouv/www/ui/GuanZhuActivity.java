...
import app.cn.aiyouv.www.adapter.GuanZhuAdapter;
...
public class GuanZhuActivity extends BaseActivity {
            ...
            case 2:
                ...
                content_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        Intent intent = new Intent(GuanZhuActivity.this,ArticleDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GuanZhuAdapter(GuanZhuActivity.this,SCREEN_WIDTH,lists,handler,deleteListioner);
    ...
    private void deleteDianZan(Article_List list){
        if(IUV.iuv.length()!=0){
            ...
            AsyncHttp.post(U.URL+U.IUV_GUANZHU,params,new ResponHandler(GuanZhuActivity.this){
                @Override
    ...
    private void loadData(boolean iscancle){
        ...
        AsyncHttp.post(U.URL+U.IUV_MY_GUANZHU,params,new ResponHandler(){
            @Override
            public void onSuccess(int index, String result) {
                super.onSuccess(index, result);
                try {
