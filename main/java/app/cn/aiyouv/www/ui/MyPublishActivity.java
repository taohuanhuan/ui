...
import app.cn.aiyouv.www.adapter.MyPublishAdapter;
...
public class MyPublishActivity extends BaseActivity {
                ...
                case 2:
                    ...
                    content_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                            Intent intent = new Intent(MyPublishActivity.this, ArticleDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyPublishAdapter(MyPublishActivity.this,SCREEN_WIDTH,lists,handler,deleteListioner);
    ...
    private void deleteDianZan(Article_List list){
        if(IUV.iuv.length()!=0){
            ...
            AsyncHttp.post(U.URL+U.IUV_ORIGINAL,params,new ResponHandler(){
                @Override
    ...
    private void loadData(boolean iscancle){
        ...
        AsyncHttp.post(U.URL+U.IUV_ORIGINAL,params,new ResponHandler(MyPublishActivity.this){
            @Override
            public void onSuccess(int index, String result) {
                super.onSuccess(index, result);
                C.p(result);
