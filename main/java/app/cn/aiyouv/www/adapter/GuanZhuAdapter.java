...
public class GuanZhuAdapter extends BaseAdapter{
    ...
    public GuanZhuAdapter(Context context, int WIDTH, ArrayList<Article_List> lists, Handler handler, OnDeleteListioner onDeleteListioner) {
