...
package app.cn.aiyouv.www.vuforia.utils;
...
// Support class for the Vuforia sample applications 支持类的vuforia示例应用程序
...
public class VuforiaApplicationGLView extends GLSurfaceView
{
    ...
    // Constructor.构造函数
    public VuforiaApplicationGLView(Context context)
    {
        super(context);
    }
