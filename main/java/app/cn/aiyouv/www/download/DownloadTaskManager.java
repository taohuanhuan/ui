...
package app.cn.aiyouv.www.download;
...
public class DownloadTaskManager {
     ...
     */
    private static final String DEFAULT_FILE_PATH = Common.AIYOUV_PATH + "/download/";
    /**
     * single instance
     */
    ...
    /**
     * Stop a task,this method  not used now閵嗕揪lease use pauseDownload instead.
     * 
     * @param downloadTask DownloadTask
     */
    @Deprecated
